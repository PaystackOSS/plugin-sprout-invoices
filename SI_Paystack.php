...
class SI_Paystack extends SI_Credit_Card_Processors {
	...
	const STRIPE_CUSTOMER_KEY_USER_META = 'si_paystack_customer_id_v1';
	...
	public static function register() {
		...
		add_action( 'recurring_payments_profile_info', array( __CLASS__, 'paystack_profile_link' ) );
	}
		...
		$settings = array(
			'si_paystack_settings' => array(
				...
				'settings' => array(
					...
					// 	'label' => __( 'Use Paystack Checkout' , 'sprout-invoices' ),
					// 	'option' => array(
					// 		'label' => __( 'Paystack Checkout uses a slick modal pop-up to handle the credit card payment.' , 'sprout-invoices' ),
					// 		'type' => 'checkbox',
					...
					// 	'label' => __( 'Disable Paystack JS' , 'sprout-invoices' ),
					// 	'option' => array(
					// 		'label' => __( 'Disable Paystack.js' , 'sprout-invoices' ),
					// 		'type' => 'checkbox',
					// 		'default' => self::$disable_paystack_js,
					// 		'value' => '1',
					// 		'description' => __( 'Only recommended if you\'re running a site with SSL already. Don\'t bother with this setting if Paystack Checkout is used.' , 'sprout-invoices' )
					// 		)
					// 	),
					)
				)
