...
With this plugin you Pay with Paystack on Sprout Invoices Plugin.
...
*    In the search box type __Paystack on Sprout Invoices__
*    From the search result you will see __Paystack on Sprout Invoices__ click on __Install Now__ to install the plugin
*    A popup window will ask you to confirm your wish to install the Plugin.
*    After installation, activate the plugin.
*    Open the settings page for  Paystack on Sprout Invoices Paystack Settings
*    Configure your __Paystack on Sprout Invoices__ api key settings as instructed on the page.
