...
Contributors: paystack, kendysond, dancameron, lukman008
...
Automatic installation is the easiest option as WordPress handles the file transfers itself and you don’t need to leave your web browser. To do an automatic install of Paystack Gateway for Sprout Invoices, log in to your WordPress dashboard, navigate to the Plugins menu and click Add New.
 
In the search field type “Paystack Gateway for Sprout Invoices” and click Search Plugins. Once you’ve found our payment plugin you can view details about it such as the point release, rating and description. Most importantly of course, you can install it by simply clicking “Install Now”.
...
If you get stuck, you can ask for help in the [Paystack Gateway for Sprouts Plugin Forum](https://wordpress.org/support/plugin/paystack-sprout-invoices). You can also directly email support@paystack.com for assistance.
 
= Paystack Gateway for Sprout Invoices is awesome! Can I contribute? =
 
Yes you can! Join in on our [GitHub repository](https://github.com/PaystackHQ/paystack-gateway-for-sprout-invoices) :)
